...
//  instances.
resource "aws_iam_role" "microfocus-demo-instance-role" {
  name = "microfocus-demo-instance-role"
...
resource "aws_iam_policy" "microfocus-demo-policy-forward-logs" {
  name        = "microfocus-demo-instance-forward-logs"
  path        = "/"
...
resource "aws_iam_policy_attachment" "microfocus-demo-attachment-forward-logs" {
  name       = "microfocus-demo-attachment-forward-logs"
  roles      = ["${aws_iam_role.microfocus-demo-instance-role.name}"]
  policy_arn = "${aws_iam_policy.microfocus-demo-policy-forward-logs.arn}"
}

//  Create a instance profile for the role.
resource "aws_iam_instance_profile" "microfocus-demo-instance-profile" {
  name  = "microfocus-demo-instance-profile"
  role = "${aws_iam_role.microfocus-demo-instance-role.name}"
}
